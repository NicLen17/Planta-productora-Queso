        ...
        <div data-aos="fade-up" className="Inicio" id="inicio">
            ...
            <div className="info-container1">
                <div data-aos="fade-up" className="info-box">
                    <img className="info-img" src="https://bmeditores.mx/wp-content/uploads/2021/06/necesidades-basicas-vacas-lecheras-1.jpg" alt="" />
                    <img className="info-img" src="https://www.infocampo.com.ar/wp-content/uploads/2018/05/leche-industria.jpg" alt="" />
                </div>
            ...
            <div data-aos="fade-up" className="queso-titulo"><b>¿Sabias que?</b></div>
            <div className="queso">
                <div className="queso-parrafo1">
                    <div data-aos="fade-right" className="queso-text1">
                    ...
                    <div>
                        <img data-aos="fade-left" className="queso-img1" src="https://elportaldelchacinado.com/media/queso-tafi-tucuman-El-Portal-del-Chacinado_xxjssr-768x486.jpg" alt="" />
                    </div>
                </div>
                <div className="queso-parrafo2">
                    <div data-aos="fade-left" className="queso-text2">
                    ...
                    <div>
                        <img data-aos="fade-right" className="queso-img2" src="https://img.lagaceta.com.ar/fotos/notas/2019/02/22/tmb1_798666_201902212001030000001.jpg" alt="" />
                    </div>
                </div>
                <div className="queso-parrafo1">
                    <div data-aos="fade-right" className="queso-text1">
                    ...
                    <div>
                        <img data-aos="fade-left" className="queso-img1" src="https://img.lagaceta.com.ar/fotos/notas/2019/02/22/798666_201902212001030000002.jpg" alt="" />
                    </div>
                </div>
                <div className="queso-parrafo2">
                    <div data-aos="fade-left" className="queso-text2">
                    ...
                    <div>
                        <img data-aos="fade-right" className="queso-img2" src="http://testcom.tallerhitmedia.com.ar/wp-content/uploads/2017/02/Jaldo-Festival-Queso-4-LS-e1519226476689.jpg" alt="" />
                    </div>
                </div>
            </div>
            ...
            <div>
                <CardGroup className="card-flex">
                    ...
                    <div className="card-flex">
                        <Card data-aos="fade-up" className="card-cont">
                            <Card.Img className="card-img1" variant="top" src="https://intucuman.info/uploads/la-overita-1.jpg" />
                            <Card.Body>
                                <Card.Title><b>La Overita</b></Card.Title>
                                <Card.Text>
                    ...
                    <div className="card-flex">
                        <Card data-aos="fade-up-left" className="card-cont">
                            <Card.Img className="card-img1" variant="top" src="http://www.cerrostucumanos.com/images/logo_historia.jpg" />
                            <Card.Body>
                ...
                <CardGroup className="card-flex">
                    <div className="card-flex">
                        <Card data-aos="fade-up-left" className="card-cont" style={{ width: "35rem" }}>
                            <Card.Img className="card-img2" variant="top" src={Cartelsv} />
                            <Card.Body>
                    ...
                    <div className="card-flex">
                        <Card data-aos="fade-up-left" className="card-cont" style={{ width: "35rem" }}>
                            <Card.Img className="card-img2" variant="top" src="https://www.tafiviejo.gob.ar/fotos/cache/notas/2021/09/08/818x460_210908160438_33083.jpg" />
                            <Card.Body>
            ...
            <div className="controles-calidad">
                ...
                <img data-aos="fade" className="calidad-img" src="https://durviz.com/wp-content/uploads/2017/06/control.png" alt="" />
            </div>
            <div className="titulos" id="about">
                <h1 data-aos="fade-right"><b>
                    Galeria
